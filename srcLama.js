    ...
    todos.forEach((todo, index) => {
        ...
        todoItem.innerHTML = `
            ...
            <div class="right__container flex__row center" style="justify-content: end">
                <button onclick="editTodo(${index})" class="button__edit" ${todo.completed ? 'disabled style="background-color: grey;"' : ''}>
                    <img src="src/edit.svg" alt="" />
                </button>
                <button onclick="doneTodo(${index})" class="button__done" ${todo.completed ? 'disabled style="background-color: grey;"' : ''}>
